      ...
      <div className="mx-auto max-w-6xl">
        <nav className="glass-nav flex items-center justify-between rounded-2xl px-5 py-3">
          ...
          <a href="/" className="flex items-center gap-3 group">
            <div className="relative h-8 w-8 rounded-xl bg-gradient-to-br from-blue-600 to-indigo-600 flex items-center justify-center shrink-0">
            ...
            <span className="text-slate-900 font-semibold text-[17px] tracking-[-0.02em] group-hover:text-blue-600 transition-colors">
              Linkea
            </span>
          </a>
          ...
          <a
            href="#whitelist"
            className="hidden sm:inline-flex items-center gap-2 text-blue-600 hover:text-blue-700 text-sm font-medium px-4 py-2 rounded-full border border-blue-200 bg-blue-50 hover:bg-blue-100 hover:border-blue-300 transition-all duration-200"
          >
            Accès beta
