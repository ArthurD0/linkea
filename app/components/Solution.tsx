    ...
    <section id="solution" className="relative py-36 px-6 overflow-hidden"
      ...
      <div className="absolute top-0 left-1/2 -translate-x-1/2 pointer-events-none"
        style={{
          ...
          background: "radial-gradient(ellipse 50% 70% at 50% -10%, rgba(37,99,235,0.06) 0%, transparent 60%)",
        }}/>
      ...
      <div className="relative z-10 mx-auto max-w-6xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div className="md:col-span-2 glass-card rounded-3xl p-8 group relative overflow-hidden min-h-[280px]">
            <div className="absolute -bottom-16 -right-16 w-64 h-64 rounded-full pointer-events-none opacity-0 group-hover:opacity-60 transition-opacity duration-700"
            ...
            <div className="flex items-start gap-4 mb-7">
              ...
              <span className="text-slate-200 text-sm font-mono font-bold self-start mt-2">01</span>
            </div>
            ...
            <div className="flex items-center gap-3">
              {[
                ...
                <div key={m.label} className="flex items-center gap-2 rounded-full px-3 py-1.5"
                  ...
                  <span className="text-slate-600 text-xs font-medium">{m.label}</span>
                </div>
              ))}
              <span className="text-slate-300 text-xs ml-1">→ Équipe complète</span>
            </div>
          </div>

          {/* Card 2 */}
          <div className="glass-card rounded-3xl p-8 group relative overflow-hidden">
            <div className="absolute -bottom-12 -right-12 w-48 h-48 rounded-full pointer-events-none opacity-0 group-hover:opacity-60 transition-opacity duration-700"
            ...
            <div className="flex items-start justify-between mb-7">
              ...
              <span className="text-slate-200 text-sm font-mono font-bold">02</span>
            </div>
            ...
            <div className="inline-flex items-center gap-2 text-xs font-semibold rounded-full px-3.5 py-1.5"
              style={{ color: "#7c3aed", background: "rgba(124,58,237,0.07)", border: "1px solid rgba(124,58,237,0.14)" }}>
          ...
          {/* Card 3 */}
          <div className="glass-card rounded-3xl p-8 group relative overflow-hidden">
            <div className="absolute -top-12 -left-12 w-48 h-48 rounded-full pointer-events-none opacity-0 group-hover:opacity-60 transition-opacity duration-700"
              style={{ background: "radial-gradient(ellipse, rgba(8,145,178,0.08) 0%, transparent 65%)" }}/>

            <div className="flex items-start justify-between mb-7">
              <div className="w-12 h-12 rounded-2xl flex items-center justify-center"
                style={{ background: "rgba(8,145,178,0.07)", border: "1px solid rgba(8,145,178,0.14)" }}>
              ...
              <span className="text-slate-200 text-sm font-mono font-bold">03</span>
            </div>
            ...
            <div className="inline-flex items-center gap-2 text-xs font-semibold rounded-full px-3.5 py-1.5"
              style={{ color: "#0891b2", background: "rgba(8,145,178,0.06)", border: "1px solid rgba(8,145,178,0.14)" }}>
          ...
          <div className="md:col-span-2 glass-card rounded-3xl p-8 group relative overflow-hidden">
            <div className="absolute inset-0 pointer-events-none opacity-0 group-hover:opacity-100 transition-opacity duration-700"
              style={{ background: "radial-gradient(ellipse at 80% 50%, rgba(37,99,235,0.03) 0%, transparent 60%)" }}/>

            <p className="text-blue-600/50 text-[11px] font-semibold uppercase tracking-[0.18em] mb-8">Résultats moyens</p>
              ...
              {[
                ...
                <div key={i}>
                  <div className="flex items-baseline gap-1.5 mb-1">
                    ...
                    <span className="text-blue-600/60 text-sm font-semibold">{s.unit}</span>
                  </div>
