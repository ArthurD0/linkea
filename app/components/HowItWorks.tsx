...
export default function HowItWorks() {
  return (
    <section id="how-it-works" className="relative py-36 px-6 overflow-hidden"
      style={{ background: "linear-gradient(180deg, #020912 0%, #050f24 50%, #020912 100%)" }}>
      ...
      <div className="absolute top-0 left-1/2 -translate-x-1/2 pointer-events-none"
        style={{
          ...
          background: "radial-gradient(ellipse 55% 75% at 50% -5%, rgba(37,99,235,0.2) 0%, rgba(99,102,241,0.08) 40%, transparent 65%)",
        }}/>

      {/* Subtle left/right flares */}
      <div className="absolute top-1/2 -translate-y-1/2 -left-20 w-80 h-80 pointer-events-none"
        style={{ background: "radial-gradient(ellipse, rgba(99,102,241,0.1) 0%, transparent 70%)", filter: "blur(50px)" }}/>
      <div className="absolute top-1/2 -translate-y-1/2 -right-20 w-80 h-80 pointer-events-none"
        style={{ background: "radial-gradient(ellipse, rgba(56,189,248,0.08) 0%, transparent 70%)", filter: "blur(50px)" }}/>
      ...
      <div className="relative z-10 mx-auto max-w-6xl">
        ...
        <div className="text-center mb-24">
          ...
          <h2 className="text-5xl sm:text-6xl md:text-7xl font-bold text-white tracking-[-0.03em] leading-[0.97] mb-6">
            ...
            <br/>
            <span className="text-white/22">en 3 étapes.</span>
          </h2>
        ...
        <div className="relative grid grid-cols-1 md:grid-cols-3 gap-5">
          ...
          {/* Connector (desktop) — spans from right edge of orb 1 to left edge of orb 3 */}
          <div className="hidden md:block absolute top-14 pointer-events-none h-px"
            style={{
              left: "calc(16.667% + 56px)",
              right: "calc(16.667% + 56px)",
              background: "linear-gradient(90deg, rgba(59,130,246,0.35), rgba(129,140,248,0.35), rgba(56,189,248,0.35))",
            }}>
            <div className="absolute top-1/2 left-1/2 -translate-y-1/2 -translate-x-1/2 w-2 h-2 rounded-full bg-indigo-400/50"/>
          </div>
            ...
            <div key={i} className="group relative">
              ...
              <div className="flex justify-center mb-7">
                <div className="relative w-28 h-28 rounded-full flex items-center justify-center"
                  style={{
                    background: `${step.color}0b`,
                    border: `1px solid ${step.color}22`,
                    boxShadow: `0 0 0 8px ${step.color}06`,
                  }}>
                  {/* Pulse ring */}
                  ...
                  <span className="font-black text-4xl tracking-tight"
                    style={{ color: step.color, textShadow: `0 0 20px ${step.color}60` }}>
                    {step.n}
                  </span>
                </div>
              </div>
              ...
              <div className="glass-card rounded-3xl p-7 relative overflow-hidden">
                <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-600 pointer-events-none rounded-3xl"
                  style={{ background: `radial-gradient(ellipse at 40% 30%, ${step.color}08, transparent 65%)` }}/>
                ...
                <h3 className="text-lg font-bold text-white/90 mb-3 tracking-[-0.02em]">{step.title}</h3>
                ...
                <div className="inline-flex items-center gap-2 text-xs font-semibold rounded-full px-3.5 py-1.5"
                  style={{ color: step.color, background: `${step.color}0e`, border: `1px solid ${step.color}1c` }}>
